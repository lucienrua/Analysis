...
> [!theorem] 和差化积公式（逆用得到积化和差公式，常用于如 $\displaystyle \int \sin ax \cos bx \mathrm{d}x$）
> 
...
> [!theorem] 柯西-施瓦茨不等式 (Cauchy-Schwarz 不等式)
> 
...
> [!theorem] 赫尔德不等式 (Hölder's Inequality)
> 
...
> [!theorem] 闵可夫斯基不等式 (Minkowski's Inequality)
> 
...
> [!theorem] 伯努利不等式 (Bernoulli's Inequality)
> 
